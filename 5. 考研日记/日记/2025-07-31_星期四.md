...
date: 2025-07-31
day_of_week: 星期四
main_focus: 高数第九讲课本例题，专业课第三章视频冲！
mood: 3
tags:
  - 复盘
  - 日记
...
# 🗓️ 2025-07-31 `$= dv.current().file.day ? dv.current().file.day.weekdayStr : "作战日志"`
...
- [ ] **行动计划**：(3+1)
    - [ ] **创建/更新【知识枢纽】**：
    - [ ] **创建/更新【深度解析】**：[[深度解析：区间再现,对称区间,xfx公式及应用]]
    - [ ] **创建【战术卡片】**：
...
> 	1. 今天整体状态都不错。任务也都基本完成。今天最让我感到开心的还是真正利用模板做些事情了，具体可以看上面的笔记。我还做了个[[PZ8-🗼每日一题：灯塔计划元数据|每日一题模板]]
> 	2. 数学：表格积分法+华罗庚拆项+一个二级结论：$∫sec^3tdt=\frac{sec^2tsint}{2}+∫sectdt$)
> 	3. 下午专业课部分：其实这几天下午都开始得比较晚，但好在效率很高。每天的学习节奏很紧促，今天快把视频课看完了。明天应该可以处理完剩下的视频内容和思考题。
>
> 2.  **坚韧时刻 (Moment of Grit):** 面对哪个难题，您没有放弃，并最终通过查阅、思考、总结攻克了它？这个过程带给您最大的收获是什么？
> 	1. 数学今天没有令我伤脑筋的地方，无非就是速度慢点，慢慢积分慢慢做嘛，要留意左边的看板了。以后每天数学看些补充视频。
> 	2. 今天晚上有些放肆了，但心态还行。因为每天确实辛苦，所以其他地方没必要再管得太严。但还是得注意一些的。
> 	3. 每日一题今天创建了，后续也要开始做起来；
> 3.  **明日航向 (Course for Tomorrow):** 基于今天的战果与挑战，您认为明天最值得投入精力的“高价值目标”是什么？
> 	1. 数学可以开新的一章了。但每天也要看些补充视频；
> 	2. 今晚专业课没有做一道数学建模题，明天补上吧；
